...
public final class JTableButton extends JFrame {
	...
	private Object[][] __rows = { { "One", new JButton("Button One") }, { "Two", new JButton("Button Two") },
			{ "Three", new JButton("Button Three") }, { "Four", new JButton("Button Four") } };
	...
	public JTableButton() {
		...
		__table = new JTable(new JTableButtonModel(__rows,__columns));
		
		JButton jbt  = new JButton();
		jbt.setIcon(new ImageIcon("ui/button/searchbutton1.png"));
		Object[] rowdata = new Object[2];
		rowdata[0] = "button";
		rowdata[1] = jbt;
		
		((DefaultTableModel)__table.getModel()).addRow(rowdata);
	...
	class JTableButtonModel extends DefaultTableModel {
		...
		public JTableButtonModel(Object[][] __rows,String[] __columns) {
			super(__rows, __columns);
		}
